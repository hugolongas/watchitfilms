...
<section id="cover" class="sceneElement" data-viewport="0">
    <div id="cover-container">        
        <div id="cover-center">            
            <img src="/storage/{{$file}}" class="img-fluid cover-img">
            <div class="cover-text">
                    <p>
                        Esto podría ser tu marca, <strong>¿te lo imaginas? </strong>
                    </p>
                </div>                
        </div>
...
<section id="clients" class="section">
    <div id="client-container">
        <div id="client-text" class="col-12 col-md-5">
            <h3>Marcas <strong>WATCHIT</strong> con las que hemos trabajado con ilusión.</h3>
            <p>
                Tú eliges… Podemos tener un apasionado e intenso romance esporádico o puntual, o labrarnos una relación de confianza plena, amor por los detalles y crecimiento mutuo.
            </p>
        </div>
...
<section id="footer" class="section">
    <div class="footer-text">
        Precisamente lo que imagines para tu marca, podría serlo, incluso más.
    </div>
