...
<html lang="es">
    <head>
        ...
        <title>Watchitfilms - Politica de privacidad</title>
    </head>
    <body>
        <main id="main" class="warpper">
            <div id="content" class="politica">                
                @include('navbar.home')
                <div id="politica" class="container-fluid">
                    <h1>Política de Privacidad</h1>
                    <p>
                        <strong>Watchitfilms</strong> te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web <strong>watchitfilms.es</strong>.
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>Titular: <strong>Watchitfilms</strong></li>                        
                        <li>NIF/CIF:<strong>F67417915</strong></li>
                        <li>Domicilio:<strong>Centre Audiovisual Roca Umbert, Carrer d'Enric Prat de la Riba, 77 08401 Granollers, Barcelona </strong></li>
                        <li>Correo electrónico: <strong>hello@watchitfilms.es</strong></li>
                        <li>Sitio Web: <strong>watchitfilms.es</strong></li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <strong>Principio de licitud, lealtad y transparencia:</strong> El Titular siempre requerirá el consentimiento para el tratamiento de tus datos personales que puede ser para uno o varios fines específicos sobre los que te informará previamente con absoluta transparencia.
                        </li>
                        <li>
                            <strong>Principio de minimización de datos:</strong> El Titular te solicitará solo los datos estrictamente necesarios para el fin o los fines que los solicita.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Principio de integridad y confidencialidad:</strong> Tus datos serán tratados de tal manera que su seguridad, confidencialidad e integridad esté garantizada.<br>
                    ...
                    <p>
                        Para navegar por <strong>watchitfilms.es</strong> no es necesario que facilites ningún dato personal. Los casos en los que sí proporcionas tus datos personales son los siguientes:
                    </p>
                    <ul>
                        <li>
                    ...
                    <p>
                        Para ejercitar tus derechos de acceso, rectificación, cancelación, portabilidad y oposición tienes que enviar un correo electrónico a <strong>hello@watchitfilms.es</strong> junto con la prueba válida en derecho como una fotocopia del D.N.I. o equivalente.
                    </p>
                    <p>
                        ...
                        <ul>
                            <li>
                                <strong>Formularios de contacto:</strong> El Titular solicita datos personales entre los que pueden estar: Nombre y apellidos, dirección de correo electrónico, número de teléfono y dirección de tu sitio Web con la finalidad de responder a tus consultas.<br>
                    ...
                    <ul>
                        ...
                        <p>
                            El sitio Web está alojado en <strong>SERED HOSTING S.L</strong> La seguridad de tus datos está garantizada, ya que toman todas las medidas de seguridad necesarias para ello. Puedes consultar su política de privacidad para tener más información.
                        </p>
                        ...
                        <p>
                        <a href="{{route('politica-cookie')}}" target="_blank">Política de cookies</a>
                        </p>
                        ...
                        <p>
                            Para contactar con el Titular tienes que aceptar la presente Política de Privacidad.
                        </p>
                        ...
                        <p>
                            ...
                            <ul>
                                <li>
                                    <strong>Google Analytics</strong> es un servicio de analítica web prestado por Google, Inc., una compañía de Delaware cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (“Google”).Encontrarás más información en:<b><a target="_blank" href="https://analytics.google.com" rel="nofollow">https://analytics.google.com</a></b><br>
                            ...
                            <p>
                                Al navegar por <strong>watchitfilms.es</strong> se pueden recoger datos no identificativos, que pueden incluir, la dirección IP, geolocalización, un registro de cómo se utilizan los servicios y sitios, hábitos de navegación y otros datos que no pueden ser utilizados para identificarte.
                            </p>
                            <p>
